				...
				<div className='grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0'>
					{projectData.map(
						({
							...
							<div
								key={id}
								className='flex flex-col justify-between shadow-md shadow-sky-600 rounded-lg text-center p-2'
							>
								{/* <img
                src={src}
                alt={title}
              ...
              /> */}
								...
								<div className='flex items-center justify-center'>
									<Button
										href={demo}
										target='_blank'
										className='w-1/2  m-4 duration-200 hover:scale-105 cursor-pointer rounded-md  '
									>
										Demo
									</Button>
									<Button
